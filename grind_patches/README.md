...
- `1f56683b1_snapshot_grid_edge_cases.patch`
  - `git format-patch` output for commit `1f56683b17cee1bacf55d54874a7019c258fc904`.

- `1f56683b1_snapshot_grid_edge_cases.bundle`
...
```bash
cp grind_patches/1f56683b1_snapshot_grid_edge_cases.bundle /tmp/fix.bundle
...
```bash
git am < grind_patches/1f56683b1_snapshot_grid_edge_cases.patch
```
