...
def generate_cases() -> dict[str, Any]:
    ...
    _add_case(cases, prefix="degrees", tags=["math", "DEGREES"], formula="=DEGREES(PI())")
    _add_case(cases, prefix="sinh", tags=["math", "SINH"], formula="=SINH(0)")
    _add_case(cases, prefix="cosh", tags=["math", "COSH"], formula="=COSH(0)")
    _add_case(cases, prefix="tanh", tags=["math", "TANH"], formula="=TANH(0)")
    _add_case(cases, prefix="asinh", tags=["math", "ASINH"], formula="=ASINH(0)")
    _add_case(cases, prefix="acosh", tags=["math", "ACOSH"], formula="=ACOSH(1)")
    _add_case(cases, prefix="atanh", tags=["math", "ATANH"], formula="=ATANH(0)")
    _add_case(cases, prefix="cot", tags=["math", "COT"], formula="=COT(1)")
    _add_case(cases, prefix="csc", tags=["math", "CSC"], formula="=CSC(1)")
    _add_case(cases, prefix="sec", tags=["math", "SEC"], formula="=SEC(1)")
    _add_case(cases, prefix="acot", tags=["math", "ACOT"], formula="=ACOT(1)")
    _add_case(cases, prefix="coth", tags=["math", "COTH"], formula="=COTH(1)")
    _add_case(cases, prefix="csch", tags=["math", "CSCH"], formula="=CSCH(1)")
    _add_case(cases, prefix="sech", tags=["math", "SECH"], formula="=SECH(1)")
    _add_case(cases, prefix="acoth", tags=["math", "ACOTH"], formula="=ACOTH(2)")
    _add_case(cases, prefix="fact", tags=["math", "FACT"], formula="=FACT(5)")
    _add_case(cases, prefix="factdouble", tags=["math", "FACTDOUBLE"], formula="=FACTDOUBLE(6)")
    _add_case(cases, prefix="combin", tags=["math", "COMBIN"], formula="=COMBIN(5,2)")
    _add_case(cases, prefix="combina", tags=["math", "COMBINA"], formula="=COMBINA(3,2)")
    _add_case(cases, prefix="permut", tags=["math", "PERMUT"], formula="=PERMUT(5,2)")
    _add_case(cases, prefix="permutationa", tags=["math", "PERMUTATIONA"], formula="=PERMUTATIONA(3,2)")
    _add_case(cases, prefix="gcd", tags=["math", "GCD"], formula="=GCD(24,36)")
    _add_case(cases, prefix="lcm", tags=["math", "LCM"], formula="=LCM(4,6)")
    _add_case(cases, prefix="multinomial", tags=["math", "MULTINOMIAL"], formula="=MULTINOMIAL(1,2,3)")
    _add_case(cases, prefix="mround", tags=["math", "MROUND"], formula="=MROUND(10,3)")
    _add_case(cases, prefix="even", tags=["math", "EVEN"], formula="=EVEN(1)")
    _add_case(cases, prefix="odd", tags=["math", "ODD"], formula="=ODD(2)")
    _add_case(cases, prefix="iseven", tags=["math", "ISEVEN"], formula="=ISEVEN(2)")
    _add_case(cases, prefix="isodd", tags=["math", "ISODD"], formula="=ISODD(3)")
    _add_case(cases, prefix="quotient", tags=["math", "QUOTIENT"], formula="=QUOTIENT(5,2)")
    _add_case(cases, prefix="sqrtpi", tags=["math", "SQRTPI"], formula="=SQRTPI(1)")
    _add_case(cases, prefix="delta", tags=["math", "DELTA"], formula="=DELTA(0)")
    _add_case(cases, prefix="gestep", tags=["math", "GESTEP"], formula="=GESTEP(1,0)")
    _add_case(cases, prefix="seriessum", tags=["math", "SERIESSUM"], formula="=SERIESSUM(2,0,1,{1,2,3})")
    _add_case(cases, prefix="sumxmy2", tags=["math", "SUMXMY2"], formula="=SUMXMY2({1,2},{3,4})")
    ...
    _add_case(cases, prefix="ispmt", tags=["financial", "ISPMT"], formula="=ISPMT(0.1, 1, 3, 300)")
    _add_case(cases, prefix="dollarde", tags=["financial", "DOLLARDE"], formula="=DOLLARDE(1.02, 16)")
    _add_case(cases, prefix="dollarfr", tags=["financial", "DOLLARFR"], formula="=DOLLARFR(1.125, 16)")
