...
For the overall “images in cells” packaging overview (including the optional `xl/cellimages.xml` store part (some producers use `xl/cellImages.xml`), `xl/metadata.xml`,
