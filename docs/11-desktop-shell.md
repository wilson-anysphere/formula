...
- Tauri plugins:
  ...
  - `tauri_plugin_shell` (used for external link opening; the UI generally routes through the `open_external_url` command, and the window capability also grants `shell:allow-open`)
