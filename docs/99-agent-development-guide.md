...
```bash
python -c 'from pathlib import Path; import re; p=Path("scratchpad.md"); s=p.read_text(encoding="utf-8", errors="surrogateescape"); p.write_text(re.sub(r"(?:\\{1,2}r)?\\{1,2}n\+", "\n", s), encoding="utf-8", errors="surrogateescape")'
```
