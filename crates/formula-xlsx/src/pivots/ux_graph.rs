...
impl XlsxPackage {
    ...
    pub fn pivot_ux_graph(&self) -> Result<XlsxPivotUxGraph, XlsxError> {
        ...
        let pivot_tables = pivot_graph.pivot_tables;
        let slicers = slicer_parts.slicers;
        let timelines = slicer_parts.timelines;
        ...
        let mut pivot_chart_to_pivot_table: Vec<Option<usize>> =
            Vec::with_capacity(pivot_charts.len());
