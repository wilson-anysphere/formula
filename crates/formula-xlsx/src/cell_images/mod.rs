...
///
/// Excel stores the image catalog in `xl/cellimages.xml` (and/or `xl/cellimages*.xml`),
/// with image payloads referenced via the part's relationships (`xl/_rels/cellimages*.xml.rels`).
///
