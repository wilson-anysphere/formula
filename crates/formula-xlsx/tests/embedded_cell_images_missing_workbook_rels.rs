...
#[test]
fn embedded_cell_images_discovers_sheets_without_workbook_rels() {
    // `XlsxPackage::worksheet_parts()` requires `xl/_rels/workbook.xml.rels`, but in the wild we
    // sometimes see minimal/malformed packages that omit it. `extract_embedded_cell_images` should
    // still be able to find worksheets by scanning `xl/worksheets/*`.
...
<workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
 xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  <sheets>
    ...
    // vm="1" exercises the 1-based relationship-slot fallback in the absence of `xl/metadata.xml`.
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/image" Target="../media/image1.png"/>
    ...
    let bytes = build_package(&[
        ...
        // Intentionally omit `xl/_rels/workbook.xml.rels`.
