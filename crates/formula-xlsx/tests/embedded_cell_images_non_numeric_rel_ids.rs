...
#[test]
fn embedded_cell_images_accept_non_numeric_relationship_ids() {
    // OPC relationship IDs are not required to be numeric (`rId1`, `rId2`, ...). Ensure we can
    // resolve `richValueRel.xml` entries that reference a non-numeric ID.
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="worksheets/sheet1.xml"/>
    ...
    // No metadata/richValue tables: exercise the fallback path that interprets `vm` as a direct
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rIdImg" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/image" Target="../media/image1.png"/>
    ...
    let img = images.get(&key).expect("expected embedded image");
