...
#[test]
fn embedded_cell_images_supports_numbered_rich_value_rel_part() {
    // Some producers use a numbered `richValueRel*.xml` part (e.g. richValueRel1.xml) instead of
    // the canonical `richValueRel.xml`. Ensure extraction discovers it.
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/image" Target="../media/image1.png"/>
    ...
    let bytes = build_package(&[
        ...
        // Use richValueRel1.xml (not the canonical richValueRel.xml).
        ("xl/richData/richValueRel1.xml", rich_value_rel_xml),
        ("xl/richData/_rels/richValueRel1.xml.rels", rich_value_rel_rels),
