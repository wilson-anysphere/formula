...
#[test]
fn load_from_bytes_resolves_percent_encoded_drawing_part_names() {
    // Relationship target contains an unescaped space (producer bug), while the stored ZIP entry is
    // percent-encoded.
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/drawing" Target="../drawings/drawing 1.xml"/>
</Relationships>"#;
...
<xdr:wsDr xmlns:xdr="http://schemas.openxmlformats.org/drawingml/2006/spreadsheetDrawing"
 ...
 xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  <xdr:twoCellAnchor>
    ...
    // Relationships part must exist for `DrawingPart::parse_from_parts` even if unused.
...
<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">
  ...
  <Override PartName="/xl/drawings/drawing%201.xml" ContentType="application/vnd.openxmlformats-officedocument.drawing+xml"/>
</Types>"#,
        ),
        ...
        // Store the drawing part percent-encoded.
        ("xl/drawings/drawing%201.xml", drawing_xml),
        ("xl/drawings/_rels/drawing%201.xml.rels", drawing_rels),
    ]);
