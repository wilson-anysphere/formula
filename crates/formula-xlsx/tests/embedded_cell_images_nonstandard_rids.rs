...
#[test]
fn embedded_cell_images_accepts_nonstandard_relationship_ids() {
    // Relationship IDs are commonly `rIdN`, but OPC allows arbitrary IDs. Ensure we don't require
    // an `rId`-digits pattern for richValueRel entries.
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="worksheets/sheet1.xml"/>
    ...
    // Fallback mode: no metadata/richValue parts; interpret vm as a relationship-slot index.
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="imgRel1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/image" Target="../media/image1.png"/>
</Relationships>"#;
