...
fn minimal_drawing_xml() -> &'static [u8] {
...
fn empty_drawing_rels_xml() -> &'static [u8] {
    br#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
</Relationships>"#
}

fn assert_sheet_has_shape(bytes: &[u8]) {
...
#[test]
fn load_from_bytes_resolves_drawing_target_relative_to_xl_root() {
...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
 xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  ...
  <drawing r:id="rId1"/>
    ...
    // Non-canonical Target: relative to `xl/` rather than `xl/worksheets/`.
...
<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">
  ...
  <Override PartName="/xl/drawings/drawing1.xml" ContentType="application/vnd.openxmlformats-officedocument.drawing+xml"/>
        ...
        ("xl/drawings/drawing1.xml", minimal_drawing_xml()),
        ("xl/drawings/_rels/drawing1.xml.rels", empty_drawing_rels_xml()),
    ]);

    assert_sheet_has_shape(&bytes);
}

#[test]
fn load_from_bytes_resolves_drawing_target_missing_leading_slash() {
    let workbook_xml = br#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
 xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  <sheets>
...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
 xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  ...
  <drawing r:id="rId1"/>
    ...
    // Non-canonical Target: `xl/...` without a leading `/`.
    let sheet_rels = br#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
