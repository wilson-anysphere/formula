...
use formula_xlsx::{worksheet_parts_from_reader, write_workbook_to_writer, XlsxError};
use zip::ZipArchive;
...
#[test]
fn worksheet_parts_from_reader_rejects_oversized_workbook_xml() {
    ...
    let err = worksheet_parts_from_reader(Cursor::new(bytes))
