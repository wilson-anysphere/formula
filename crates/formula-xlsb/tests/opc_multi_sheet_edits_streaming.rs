...
fn build_three_sheet_fixture_bytes() -> Vec<u8> {
    ...
    zip_out
        .start_file("xl/worksheets/sheet3.bin", options)
    ...
    zip_out
        .start_file("xl/calcChain.bin", options)
...
#[test]
fn save_with_cell_edits_streaming_multi_changes_only_edited_sheet_parts() {
    ...
    wb.save_with_cell_edits_streaming_multi(&out_path, &edits_by_sheet)
        .expect("save_with_cell_edits_streaming_multi");
