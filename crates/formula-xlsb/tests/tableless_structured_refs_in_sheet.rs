...
#[test]
fn rejects_tableless_this_row_structured_ref_outside_table_using_sheet_context() {
    let mut builder = XlsbFixtureBuilder::new();
...
"#;
    ...
    // Pick a base cell outside the table range `A1:B10`.
    let base = CellCoord::new(10, 0); // A11
