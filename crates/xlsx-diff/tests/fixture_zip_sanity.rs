...
/// corpus.
///
/// The ZIP/OPC round-trip harness assumes each `*.xlsx` / `*.xlsm` / `*.xlsb` file under
/// `fixtures/xlsx/**` is a ZIP/Open Packaging Convention container. Password-protected OOXML files
/// are *not* ZIPs: Excel stores them as OLE/CFB compound documents (`D0 CF 11 E0 A1 B1 1A E1`
/// header).
#[test]
