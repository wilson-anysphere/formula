...
#[test]
fn merge_cells_order_is_not_ignored_outside_worksheet_parts() {
    let a = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
  <mergeCells count="2">
    <mergeCell ref="C3:D4"/>
...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
  <mergeCells count="2">
    ...
    // The merge cell ordering rules are intended only for worksheet parts named
    // `xl/worksheets/sheet*.xml`.
    let ax = NormalizedXml::parse("xl/worksheets/other.xml", a.as_bytes()).unwrap();
    let bx = NormalizedXml::parse("xl/worksheets/other.xml", b.as_bytes()).unwrap();

    let diffs = diff_xml(&ax, &bx, Severity::Critical);
    assert!(!diffs.is_empty(), "expected diffs, got empty");
}
...
#[test]
fn hyperlinks_order_is_not_ignored_outside_worksheet_parts() {
    let a = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
           xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  <hyperlinks>
...
#[test]
fn data_validations_order_is_not_ignored_outside_worksheet_parts() {
    let a = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
  <dataValidations count="2">
    <dataValidation type="whole" sqref="B2"/>
...
#[test]
fn conditional_formatting_rules_are_not_sorted_outside_worksheet_parts() {
    let a = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
  <conditionalFormatting sqref="A1">
    <cfRule type="expression" priority="2"/>
