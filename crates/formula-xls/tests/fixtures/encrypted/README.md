...
| `biff8_rc4_cryptoapi_pw_open_empty_password.xls` | RC4 (CryptoAPI) | BIFF8 | same as above | `""` |
...
| `biff8_rc4_cryptoapi_legacy_unicode_emoji_pw_open.xls` | RC4 (CryptoAPI, legacy FILEPASS layout) | BIFF8 | same as above | `pässwörd🔒` |
| `biff8_rc4_cryptoapi_legacy_pw_open_empty_password.xls` | RC4 (CryptoAPI, legacy FILEPASS layout) | BIFF8 | same as above | `""` |
