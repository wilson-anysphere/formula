...
fn dax_identifier_requires_quotes(raw: &str) -> bool {
    ...
    // In DAX, unquoted table identifiers are fairly restrictive. Quote whenever the identifier
    // contains whitespace/punctuation or begins with a non-letter character (e.g. digits).
