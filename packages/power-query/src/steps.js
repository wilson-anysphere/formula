 ...
 *
 * This includes special-casing `promoteHeaders`, which is executed by the engine by consuming the
 * first data row at each `promoteHeaders` point to derive the new header names.
 *
