...
- under **structured** DLP redaction, replace user-controlled schema/metadata tokens (e.g. sheet/table/namedRange names, chunk titles) with placeholders so non-heuristic sensitive strings can’t leak even with a no-op redactor
