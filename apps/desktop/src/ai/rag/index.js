...
import { HashEmbedder, JsonFileVectorStore, indexWorkbook } from "../../../../../packages/ai-rag/src/index.js";
 ...
 * entire sheets.
 */
function defaultStorePath(workbookId) {
...
export function createDesktopRag(opts) {
  ...
  const storePath = opts.storePath ?? defaultStorePath(workbookId);
