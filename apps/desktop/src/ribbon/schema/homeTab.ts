  ...
  groups: [
    ...
    },
    {
      ...
      buttons: [
        ...
        { id: "format.fontSize.increase", label: "Grow Font", ariaLabel: "Increase Font Size", iconId: "increaseFont", size: "icon" },
        { id: "format.fontSize.decrease", label: "Shrink Font", ariaLabel: "Decrease Font Size", iconId: "decreaseFont", size: "icon" },
        ...
        { id: "format.toggleSubscript", label: "Subscript", ariaLabel: "Subscript", iconId: "subscript", kind: "toggle", size: "icon" },
        { id: "format.toggleSuperscript", label: "Superscript", ariaLabel: "Superscript", iconId: "superscript", kind: "toggle", size: "icon" },
        {
