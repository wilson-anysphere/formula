      ...
      buttons: [
        {
          ...
          menuItems: [
            {
              id: "insert.illustrations.pictures.thisDevice",
              label: "This Device…",
              ariaLabel: "Pictures from this device",
              iconId: "image",
              testId: "ribbon-insert-pictures-this-device",
            },
            {
              id: "insert.illustrations.pictures.stockImages",
              label: "Stock Images…",
              ariaLabel: "Stock Images",
              iconId: "sparkles",
              testId: "ribbon-insert-pictures-stock-images",
            },
            {
              id: "insert.illustrations.pictures.onlinePictures",
              label: "Online Pictures…",
              ariaLabel: "Online Pictures",
              iconId: "globe",
              testId: "ribbon-insert-pictures-online-pictures",
            },
          ],
        },
