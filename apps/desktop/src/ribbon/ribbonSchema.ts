      ...
      groups: [
        ...
        },
        {
          ...
          buttons: [
            ...
            { id: "home.insert.insertCells", label: "Insert Cells", ariaLabel: "Insert Cells", icon: "⊞", kind: "dropdown" },
            { id: "home.insert.insertRows", label: "Insert Sheet Rows", ariaLabel: "Insert Sheet Rows", icon: "↧", kind: "dropdown" },
            { id: "home.insert.insertColumns", label: "Insert Sheet Columns", ariaLabel: "Insert Sheet Columns", icon: "↦", kind: "dropdown" },
            { id: "home.insert.insertSheet", label: "Insert Sheet", ariaLabel: "Insert Sheet", icon: "📄", kind: "dropdown" },
            { id: "home.delete.deleteCells", label: "Delete Cells", ariaLabel: "Delete Cells", icon: "⊟", kind: "dropdown" },
            { id: "home.delete.deleteRows", label: "Delete Sheet Rows", ariaLabel: "Delete Sheet Rows", icon: "↥", kind: "dropdown" },
            { id: "home.delete.deleteColumns", label: "Delete Sheet Columns", ariaLabel: "Delete Sheet Columns", icon: "↤", kind: "dropdown" },
            { id: "home.delete.deleteSheet", label: "Delete Sheet", ariaLabel: "Delete Sheet", icon: "🗑", kind: "dropdown" },
            { id: "home.format.formatCells", label: "Format Cells", ariaLabel: "Format Cells", icon: "⚙️", kind: "dropdown" },
            { id: "home.format.rowHeight", label: "Row Height", ariaLabel: "Row Height", icon: "↕", kind: "dropdown" },
            { id: "home.format.columnWidth", label: "Column Width", ariaLabel: "Column Width", icon: "↔", kind: "dropdown" },
            { id: "home.format.organizeSheets", label: "Organize Sheets", ariaLabel: "Organize Sheets", icon: "🗂", kind: "dropdown" },
          ],
        },
        {
          id: "home.editing",
