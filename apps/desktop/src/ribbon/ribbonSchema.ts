          ...
          buttons: [
            {
              ...
              menuItems: [
                ...
                { id: "file.new.templates", label: "Templates", ariaLabel: "Templates", icon: "📑" },
                { id: "file.new.fromExisting", label: "New from existing…", ariaLabel: "New from existing", icon: "📄" },
              ],
            },
            { id: "file.new.blankWorkbook", label: "Blank workbook", ariaLabel: "Blank workbook", icon: "⬜" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "file.new.templates.budget", label: "Budget", ariaLabel: "Budget template", icon: "💰" },
                { id: "file.new.templates.invoice", label: "Invoice", ariaLabel: "Invoice template", icon: "🧾" },
                { id: "file.new.templates.calendar", label: "Calendar", ariaLabel: "Calendar template", icon: "📅" },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "file.info.protectWorkbook.encryptWithPassword", label: "Encrypt with Password…", ariaLabel: "Encrypt with Password", icon: "🔒" },
                { id: "file.info.protectWorkbook.protectCurrentSheet", label: "Protect Current Sheet…", ariaLabel: "Protect Current Sheet", icon: "🧾" },
                { id: "file.info.protectWorkbook.protectWorkbookStructure", label: "Protect Workbook Structure…", ariaLabel: "Protect Workbook Structure", icon: "🧰" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "file.info.inspectWorkbook.documentInspector", label: "Document Inspector…", ariaLabel: "Document Inspector", icon: "🔍" },
                { id: "file.info.inspectWorkbook.checkAccessibility", label: "Check Accessibility", ariaLabel: "Check Accessibility", icon: "♿" },
                { id: "file.info.inspectWorkbook.checkCompatibility", label: "Check Compatibility", ariaLabel: "Check Compatibility", icon: "✅" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                 { id: "file.info.manageWorkbook.recoverUnsaved", label: "Recover Unsaved Workbooks…", ariaLabel: "Recover Unsaved Workbooks", icon: "🕘" },
                 { id: "file.info.manageWorkbook.versions", label: "Version History", ariaLabel: "Version History", icon: "🗂" },
                 { id: "file.info.manageWorkbook.branches", label: "Branches", ariaLabel: "Branches", icon: "🌿" },
                 { id: "file.info.manageWorkbook.properties", label: "Properties", ariaLabel: "Properties", icon: "⚙️" },
               ],
             },
           ],
         },
        {
          ...
          buttons: [
            { id: "file.open.open", label: "Open", ariaLabel: "Open", icon: "📂", size: "large" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "file.open.recent.book1", label: "Book1.xlsx", ariaLabel: "Open Book1", icon: "📄" },
                { id: "file.open.recent.budget", label: "Budget.xlsx", ariaLabel: "Open Budget", icon: "📄" },
                { id: "file.open.recent.forecast", label: "Forecast.xlsx", ariaLabel: "Open Forecast", icon: "📄" },
            ...
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "file.open.pinned.q4", label: "Q4 Forecast.xlsx", ariaLabel: "Open Q4 Forecast", icon: "📌" },
                { id: "file.open.pinned.kpis", label: "KPIs.xlsx", ariaLabel: "Open KPIs", icon: "📌" },
              ],
            },
          ],
        },
        {
          ...
          buttons: [
            { id: "file.save.save", label: "Save", ariaLabel: "Save", icon: "💾", size: "large", testId: "ribbon-save" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "file.save.saveAs", label: "Save As…", ariaLabel: "Save As", icon: "📝" },
                { id: "file.save.saveAs.copy", label: "Save a Copy…", ariaLabel: "Save a Copy", icon: "📄" },
                { id: "file.save.saveAs.download", label: "Download a Copy", ariaLabel: "Download a Copy", icon: "⬇" },
              ],
            },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "file.export.export.pdf", label: "PDF", ariaLabel: "Export to PDF", icon: "📄" },
                { id: "file.export.export.csv", label: "CSV", ariaLabel: "Export to CSV", icon: "🧾" },
                { id: "file.export.export.xlsx", label: "Excel Workbook", ariaLabel: "Export to Excel workbook", icon: "📊" },
              ],
            },
            { id: "file.export.createPdf", label: "Create PDF/XPS", ariaLabel: "Create PDF or XPS", icon: "📄" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "file.export.changeFileType.xlsx", label: "Excel Workbook (*.xlsx)", ariaLabel: "Excel Workbook", icon: "📊" },
                { id: "file.export.changeFileType.csv", label: "CSV (Comma delimited) (*.csv)", ariaLabel: "CSV", icon: "🧾" },
                { id: "file.export.changeFileType.tsv", label: "TSV (Tab delimited) (*.tsv)", ariaLabel: "TSV", icon: "⇥" },
                { id: "file.export.changeFileType.pdf", label: "PDF (*.pdf)", ariaLabel: "PDF", icon: "📄" },
              ],
            },
          ],
        },
        {
          ...
          buttons: [
            ...
            { id: "file.print.printPreview", label: "Print Preview", ariaLabel: "Print Preview", icon: "👁" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "file.print.pageSetup", label: "Page Setup…", ariaLabel: "Page Setup", icon: "📐" },
                { id: "file.print.pageSetup.printTitles", label: "Print Titles…", ariaLabel: "Print Titles", icon: "🏷" },
                { id: "file.print.pageSetup.margins", label: "Margins", ariaLabel: "Margins", icon: "📏" },
              ],
            },
          ],
        },
        {
          ...
          buttons: [
            { id: "file.share.share", label: "Share", ariaLabel: "Share", icon: "🔗", size: "large" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "file.share.email.attachment", label: "Send as Attachment", ariaLabel: "Send as Attachment", icon: "📎" },
                { id: "file.share.email.link", label: "Send Link", ariaLabel: "Send Link", icon: "🔗" },
              ],
            },
      ...
      groups: [
        {
          ...
          buttons: [
            ...
            { id: "home.clipboard.formatPainter", label: "Format Painter", ariaLabel: "Format Painter", icon: "🖌", size: "small" },
            {
              ...
              size: "small",
              menuItems: [
                { id: "home.clipboard.clipboardPane.open", label: "Open Clipboard", ariaLabel: "Open Clipboard", icon: "📎" },
                { id: "home.clipboard.clipboardPane.clearAll", label: "Clear All", ariaLabel: "Clear Clipboard", icon: "🧹" },
                { id: "home.clipboard.clipboardPane.options", label: "Options…", ariaLabel: "Clipboard Options", icon: "⚙️" },
              ],
            },
          ],
        },
        ...
        },
        {
          ...
          buttons: [
            ...
            },
            {
              ...
              size: "icon",
              menuItems: [
                { id: "home.font.clearFormatting.clearFormats", label: "Clear Formats", ariaLabel: "Clear Formats", icon: "🎨" },
          ...
          buttons: [
            ...
            { id: "home.alignment.alignRight", label: "Right", ariaLabel: "Align Right", icon: "➡", size: "icon" },
            {
              ...
              menuItems: [
                ...
                { id: "home.alignment.orientation.verticalText", label: "Vertical Text", ariaLabel: "Vertical Text", icon: "↕" },
                { id: "home.alignment.orientation.rotateUp", label: "Rotate Text Up", ariaLabel: "Rotate Text Up", icon: "⬆" },
                { id: "home.alignment.orientation.rotateDown", label: "Rotate Text Down", ariaLabel: "Rotate Text Down", icon: "⬇" },
                { id: "home.alignment.orientation.formatCellAlignment", label: "Format Cell Alignment…", ariaLabel: "Format Cell Alignment", icon: "⚙️" },
              ],
            },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "home.styles.conditionalFormatting.highlightCellsRules", label: "Highlight Cells Rules", ariaLabel: "Highlight Cells Rules", icon: "🟨" },
                { id: "home.styles.conditionalFormatting.topBottomRules", label: "Top/Bottom Rules", ariaLabel: "Top or Bottom Rules", icon: "⬆" },
                { id: "home.styles.conditionalFormatting.dataBars", label: "Data Bars", ariaLabel: "Data Bars", icon: "▮" },
                { id: "home.styles.conditionalFormatting.colorScales", label: "Color Scales", ariaLabel: "Color Scales", icon: "🎨" },
                { id: "home.styles.conditionalFormatting.iconSets", label: "Icon Sets", ariaLabel: "Icon Sets", icon: "⭐" },
                { id: "home.styles.conditionalFormatting.manageRules", label: "Manage Rules…", ariaLabel: "Manage Rules", icon: "⚙️" },
                { id: "home.styles.conditionalFormatting.clearRules", label: "Clear Rules", ariaLabel: "Clear Rules", icon: "✖" },
              ],
            },
            {
              ...
              size: "large",
              menuItems: [
                { id: "home.styles.formatAsTable.light", label: "Light", ariaLabel: "Light table styles", icon: "⬜" },
                { id: "home.styles.formatAsTable.medium", label: "Medium", ariaLabel: "Medium table styles", icon: "⬛" },
                { id: "home.styles.formatAsTable.dark", label: "Dark", ariaLabel: "Dark table styles", icon: "⬛" },
                { id: "home.styles.formatAsTable.newStyle", label: "New Table Style…", ariaLabel: "New Table Style", icon: "➕" },
              ],
            },
            {
              ...
              size: "large",
              menuItems: [
                { id: "home.styles.cellStyles.goodBadNeutral", label: "Good, Bad, and Neutral", ariaLabel: "Good Bad and Neutral", icon: "🟩" },
                { id: "home.styles.cellStyles.dataModel", label: "Data Model", ariaLabel: "Data Model styles", icon: "📊" },
                { id: "home.styles.cellStyles.titlesHeadings", label: "Titles and Headings", ariaLabel: "Titles and Headings", icon: "🏷" },
                { id: "home.styles.cellStyles.numberFormat", label: "Number Format", ariaLabel: "Number Format styles", icon: "123" },
                { id: "home.styles.cellStyles.newStyle", label: "New Cell Style…", ariaLabel: "New Cell Style", icon: "➕" },
              ],
            },
          ],
        },
        ...
        },
        {
          ...
          label: "Freeze",
          buttons: [
            { id: "freeze-panes", label: "Freeze Panes", ariaLabel: "Freeze Panes", icon: "❄️", testId: "freeze-panes", size: "icon" },
            { id: "freeze-top-row", label: "Freeze Top Row", ariaLabel: "Freeze Top Row", icon: "⬆", testId: "freeze-top-row", size: "icon" },
            { id: "freeze-first-column", label: "Freeze First Column", ariaLabel: "Freeze First Column", icon: "⬅", testId: "freeze-first-column", size: "icon" },
            { id: "unfreeze-panes", label: "Unfreeze Panes", ariaLabel: "Unfreeze Panes", icon: "☀️", testId: "unfreeze-panes", size: "icon" },
          ],
        },
      ],
    },
          ...
          buttons: [
            {
              ...
              menuItems: [
                { id: "insert.tables.pivotTable", label: "PivotTable…", ariaLabel: "PivotTable", icon: "📊" },
                { id: "insert.tables.pivotTable.fromTableRange", label: "From Table/Range…", ariaLabel: "PivotTable from Table or Range", icon: "▦" },
                { id: "insert.tables.pivotTable.fromExternal", label: "From External Data…", ariaLabel: "PivotTable from External Data", icon: "🌐" },
                { id: "insert.tables.pivotTable.fromDataModel", label: "From Data Model…", ariaLabel: "PivotTable from Data Model", icon: "🧠" },
              ],
            },
            {
          ...
          buttons: [
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "insert.illustrations.pictures.thisDevice", label: "This Device…", ariaLabel: "Pictures from this device", icon: "🖼" },
                { id: "insert.illustrations.pictures.stockImages", label: "Stock Images…", ariaLabel: "Stock Images", icon: "⭐" },
                { id: "insert.illustrations.pictures.onlinePictures", label: "Online Pictures…", ariaLabel: "Online Pictures", icon: "🌐" },
              ],
            },
            { id: "insert.illustrations.onlinePictures", label: "Online Pictures", ariaLabel: "Online Pictures", icon: "🌐", kind: "dropdown" },
            {
              ...
              menuItems: [
                ...
                { id: "insert.illustrations.shapes.basicShapes", label: "Basic Shapes", ariaLabel: "Basic Shapes", icon: "⬛" },
                { id: "insert.illustrations.shapes.arrows", label: "Block Arrows", ariaLabel: "Block Arrows", icon: "➡" },
                { id: "insert.illustrations.shapes.flowchart", label: "Flowchart", ariaLabel: "Flowchart", icon: "🧩" },
                { id: "insert.illustrations.shapes.callouts", label: "Callouts", ariaLabel: "Callouts", icon: "💬" },
              ],
            },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "insert.charts.recommendedCharts", label: "Recommended Charts…", ariaLabel: "Recommended Charts", icon: "✨" },
                { id: "insert.charts.recommendedCharts.column", label: "Column", ariaLabel: "Recommended Column Charts", icon: "▮▮" },
                { id: "insert.charts.recommendedCharts.line", label: "Line", ariaLabel: "Recommended Line Charts", icon: "📈" },
            ...
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "insert.charts.line.line", label: "Line", ariaLabel: "Line", icon: "📈" },
                { id: "insert.charts.line.lineWithMarkers", label: "Line with Markers", ariaLabel: "Line with Markers", icon: "•" },
                { id: "insert.charts.line.stackedArea", label: "Stacked Area", ariaLabel: "Stacked Area", icon: "⛰" },
            ...
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "insert.charts.area.area", label: "Area", ariaLabel: "Area", icon: "⛰" },
                { id: "insert.charts.area.stackedArea", label: "Stacked Area", ariaLabel: "Stacked Area", icon: "⛰" },
            ...
            },
            {
              ...
              menuItems: [
                ...
                { id: "insert.charts.scatter.smoothLines", label: "Scatter with Smooth Lines", ariaLabel: "Scatter with Smooth Lines", icon: "〰" },
            ...
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "insert.charts.map.filledMap", label: "Filled Map", ariaLabel: "Filled Map", icon: "🗺" },
          ...
          buttons: [
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "insert.filters.slicer", label: "Slicer…", ariaLabel: "Insert Slicer", icon: "🔪" },
                { id: "insert.filters.slicer.reportConnections", label: "Report Connections…", ariaLabel: "Report Connections", icon: "🔗" },
              ],
            },
            {
              ...
              icon: "🕒",
              kind: "dropdown",
              menuItems: [{ id: "insert.filters.timeline", label: "Timeline…", ariaLabel: "Insert Timeline", icon: "🕒" }],
            },
          ],
        },
        {
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "pageLayout.themes.themes.office", label: "Office", ariaLabel: "Office Theme", icon: "🎛" },
                { id: "pageLayout.themes.themes.integral", label: "Integral", ariaLabel: "Integral Theme", icon: "🎛" },
                { id: "pageLayout.themes.themes.facet", label: "Facet", ariaLabel: "Facet Theme", icon: "🎛" },
                { id: "pageLayout.themes.themes.customize", label: "Customize…", ariaLabel: "Customize Theme", icon: "⚙️" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.themes.colors.office", label: "Office", ariaLabel: "Office Colors", icon: "🎨" },
                { id: "pageLayout.themes.colors.colorful", label: "Colorful", ariaLabel: "Colorful Colors", icon: "🌈" },
                { id: "pageLayout.themes.colors.customize", label: "Customize Colors…", ariaLabel: "Customize Colors", icon: "⚙️" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.themes.fonts.office", label: "Office", ariaLabel: "Office Fonts", icon: "🔤" },
                { id: "pageLayout.themes.fonts.aptos", label: "Aptos", ariaLabel: "Aptos Fonts", icon: "A" },
                { id: "pageLayout.themes.fonts.customize", label: "Customize Fonts…", ariaLabel: "Customize Fonts", icon: "⚙️" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.themes.effects.subtle", label: "Subtle", ariaLabel: "Subtle Effects", icon: "✨" },
                { id: "pageLayout.themes.effects.moderate", label: "Moderate", ariaLabel: "Moderate Effects", icon: "✨" },
                { id: "pageLayout.themes.effects.intense", label: "Intense", ariaLabel: "Intense Effects", icon: "✨" },
              ],
            },
          ],
        },
        {
          ...
          buttons: [
            { id: "pageLayout.pageSetup.pageSetupDialog", label: "Page Setup…", ariaLabel: "Page Setup", icon: "📐", size: "large", testId: "ribbon-page-setup" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.pageSetup.margins.normal", label: "Normal", ariaLabel: "Normal Margins", icon: "📏" },
                { id: "pageLayout.pageSetup.margins.wide", label: "Wide", ariaLabel: "Wide Margins", icon: "↔" },
                { id: "pageLayout.pageSetup.margins.narrow", label: "Narrow", ariaLabel: "Narrow Margins", icon: "↕" },
                { id: "pageLayout.pageSetup.margins.custom", label: "Custom Margins…", ariaLabel: "Custom Margins", icon: "⚙️" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.pageSetup.orientation.portrait", label: "Portrait", ariaLabel: "Portrait", icon: "⬜" },
            ...
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.pageSetup.size.letter", label: "Letter", ariaLabel: "Letter", icon: "📄" },
                { id: "pageLayout.pageSetup.size.a4", label: "A4", ariaLabel: "A4", icon: "📄" },
            ...
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.pageSetup.printArea.set", label: "Set Print Area", ariaLabel: "Set Print Area", icon: "🖨" },
                { id: "pageLayout.pageSetup.printArea.clear", label: "Clear Print Area", ariaLabel: "Clear Print Area", icon: "✖" },
                { id: "pageLayout.pageSetup.printArea.addTo", label: "Add to Print Area", ariaLabel: "Add to Print Area", icon: "➕" },
              ],
            },
            {
              ...
              menuItems: [
                ...
                { id: "pageLayout.pageSetup.breaks.removePageBreak", label: "Remove Page Break", ariaLabel: "Remove Page Break", icon: "✖" },
            ...
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.pageSetup.background.background", label: "Background…", ariaLabel: "Background", icon: "🖼" },
                { id: "pageLayout.pageSetup.background.delete", label: "Delete Background", ariaLabel: "Delete Background", icon: "🗑" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.pageSetup.printTitles.printTitles", label: "Print Titles…", ariaLabel: "Print Titles", icon: "🏷" },
              ],
            },
          ],
        },
          ...
          buttons: [
            ...
            },
            {
              ...
              menuItems: [
                ...
                { id: "pageLayout.scaleToFit.scale.more", label: "Custom…", ariaLabel: "Custom scale", icon: "⚙️" },
              ],
            },
          ],
        },
        ...
        },
        {
          ...
          buttons: [
            ...
            { id: "pageLayout.arrange.selectionPane", label: "Selection Pane", ariaLabel: "Selection Pane", icon: "📋" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.arrange.align.alignLeft", label: "Align Left", ariaLabel: "Align Left", icon: "⬅" },
                { id: "pageLayout.arrange.align.alignCenter", label: "Align Center", ariaLabel: "Align Center", icon: "↔" },
                { id: "pageLayout.arrange.align.alignRight", label: "Align Right", ariaLabel: "Align Right", icon: "➡" },
                { id: "pageLayout.arrange.align.alignTop", label: "Align Top", ariaLabel: "Align Top", icon: "⬆" },
                { id: "pageLayout.arrange.align.alignMiddle", label: "Align Middle", ariaLabel: "Align Middle", icon: "↕" },
                { id: "pageLayout.arrange.align.alignBottom", label: "Align Bottom", ariaLabel: "Align Bottom", icon: "⬇" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "pageLayout.arrange.group.group", label: "Group", ariaLabel: "Group", icon: "🔗" },
                { id: "pageLayout.arrange.group.ungroup", label: "Ungroup", ariaLabel: "Ungroup", icon: "✖" },
            ...
            },
            {
              ...
              menuItems: [
                ...
                { id: "pageLayout.arrange.rotate.flipVertical", label: "Flip Vertical", ariaLabel: "Flip Vertical", icon: "↕" },
                { id: "pageLayout.arrange.rotate.flipHorizontal", label: "Flip Horizontal", ariaLabel: "Flip Horizontal", icon: "↔" },
              ],
            },
          ],
        },
      ...
      groups: [
        {
          ...
          buttons: [
            { id: "formulas.functionLibrary.insertFunction", label: "Insert Function", ariaLabel: "Insert Function", icon: "fx", kind: "dropdown", size: "large" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "formulas.functionLibrary.autoSum.sum", label: "Sum", ariaLabel: "Sum", icon: "Σ" },
                { id: "formulas.functionLibrary.autoSum.average", label: "Average", ariaLabel: "Average", icon: "x̄" },
                { id: "formulas.functionLibrary.autoSum.countNumbers", label: "Count Numbers", ariaLabel: "Count Numbers", icon: "#" },
                { id: "formulas.functionLibrary.autoSum.max", label: "Max", ariaLabel: "Max", icon: "↑" },
                { id: "formulas.functionLibrary.autoSum.min", label: "Min", ariaLabel: "Min", icon: "↓" },
                { id: "formulas.functionLibrary.autoSum.moreFunctions", label: "More Functions…", ariaLabel: "More Functions", icon: "fx" },
              ],
            },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "data.getTransform.getData.fromFile", label: "From File", ariaLabel: "From File", icon: "📄" },
                { id: "data.getTransform.getData.fromDatabase", label: "From Database", ariaLabel: "From Database", icon: "🗄" },
                { id: "data.getTransform.getData.fromAzure", label: "From Azure", ariaLabel: "From Azure", icon: "☁️" },
                { id: "data.getTransform.getData.fromOnlineServices", label: "From Online Services", ariaLabel: "From Online Services", icon: "🌐" },
                { id: "data.getTransform.getData.fromOtherSources", label: "From Other Sources", ariaLabel: "From Other Sources", icon: "➕" },
              ],
            },
          ...
          buttons: [
            {
              ...
              menuItems: [
                ...
                { id: "data.queriesConnections.refreshAll.refreshAllConnections", label: "Refresh All Connections", ariaLabel: "Refresh All Connections", icon: "🔗" },
                { id: "data.queriesConnections.refreshAll.refreshAllQueries", label: "Refresh All Queries", ariaLabel: "Refresh All Queries", icon: "🗂" },
              ],
            },
        ...
        },
        {
          ...
          buttons: [
            ...
            { id: "data.sortFilter.sortZtoA", label: "Sort Z to A", ariaLabel: "Sort Z to A", icon: "Z→A" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "data.sortFilter.sort.customSort", label: "Custom Sort…", ariaLabel: "Custom Sort", icon: "⚙️" },
            ...
            { id: "data.sortFilter.reapply", label: "Reapply", ariaLabel: "Reapply", icon: "⟳" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "data.sortFilter.advanced.advancedFilter", label: "Advanced Filter…", ariaLabel: "Advanced Filter", icon: "⚙️" },
                { id: "data.sortFilter.advanced.clearFilter", label: "Clear Filter", ariaLabel: "Clear Filter", icon: "✖" },
              ],
            },
          ],
        },
        {
          ...
          buttons: [
            ...
            { id: "data.dataTools.flashFill", label: "Flash Fill", ariaLabel: "Flash Fill", icon: "⚡" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "data.dataTools.removeDuplicates", label: "Remove Duplicates…", ariaLabel: "Remove Duplicates", icon: "🗑" },
                { id: "data.dataTools.removeDuplicates.advanced", label: "Advanced…", ariaLabel: "Advanced", icon: "⚙️" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "data.dataTools.dataValidation", label: "Data Validation…", ariaLabel: "Data Validation", icon: "✅" },
                { id: "data.dataTools.dataValidation.circleInvalid", label: "Circle Invalid Data", ariaLabel: "Circle Invalid Data", icon: "⭕" },
                { id: "data.dataTools.dataValidation.clearCircles", label: "Clear Validation Circles", ariaLabel: "Clear Validation Circles", icon: "✖" },
              ],
            },
            {
              ...
              icon: "🧩",
              kind: "dropdown",
              menuItems: [{ id: "data.dataTools.consolidate", label: "Consolidate…", ariaLabel: "Consolidate", icon: "🧩" }],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "data.dataTools.relationships", label: "Relationships…", ariaLabel: "Relationships", icon: "🔗" },
                { id: "data.dataTools.relationships.manage", label: "Manage Relationships…", ariaLabel: "Manage Relationships", icon: "⚙️" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "data.dataTools.manageDataModel", label: "Manage Data Model", ariaLabel: "Manage Data Model", icon: "🧠" },
                { id: "data.dataTools.manageDataModel.addToDataModel", label: "Add to Data Model", ariaLabel: "Add to Data Model", icon: "➕" },
              ],
            },
          ],
        },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "data.forecast.whatIfAnalysis.scenarioManager", label: "Scenario Manager…", ariaLabel: "Scenario Manager", icon: "🎭" },
                { id: "data.forecast.whatIfAnalysis.goalSeek", label: "Goal Seek…", ariaLabel: "Goal Seek", icon: "🎯" },
            ...
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "data.forecast.forecastSheet", label: "Forecast Sheet…", ariaLabel: "Forecast Sheet", icon: "📈" },
                { id: "data.forecast.forecastSheet.options", label: "Options…", ariaLabel: "Forecast Options", icon: "⚙️" },
              ],
            },
          ],
        },
          ...
          buttons: [
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "data.outline.group.group", label: "Group…", ariaLabel: "Group", icon: "➕" },
            ...
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "data.outline.ungroup.ungroup", label: "Ungroup…", ariaLabel: "Ungroup", icon: "➖" },
                { id: "data.outline.ungroup.clearOutline", label: "Clear Outline", ariaLabel: "Clear Outline", icon: "✖" },
              ],
            },
            {
              ...
              icon: "Σ",
              kind: "dropdown",
              menuItems: [{ id: "data.outline.subtotal", label: "Subtotal…", ariaLabel: "Subtotal", icon: "Σ" }],
            },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "review.proofing.spelling", label: "Spelling", ariaLabel: "Spelling", icon: "✔" },
                { id: "review.proofing.spelling.thesaurus", label: "Thesaurus", ariaLabel: "Thesaurus", icon: "📚" },
                { id: "review.proofing.spelling.wordCount", label: "Word Count", ariaLabel: "Word Count", icon: "#" },
              ],
            },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "view.window.newWindow", label: "New Window", ariaLabel: "New Window", icon: "🪟" },
                { id: "view.window.newWindow.newWindowForActiveSheet", label: "New Window for Active Sheet", ariaLabel: "New Window for Active Sheet", icon: "📄" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "view.window.arrangeAll", label: "Arrange All…", ariaLabel: "Arrange All", icon: "🗔" },
                { id: "view.window.arrangeAll.tiled", label: "Tiled", ariaLabel: "Tiled", icon: "▦" },
                { id: "view.window.arrangeAll.horizontal", label: "Horizontal", ariaLabel: "Horizontal", icon: "↔" },
                { id: "view.window.arrangeAll.vertical", label: "Vertical", ariaLabel: "Vertical", icon: "↕" },
                { id: "view.window.arrangeAll.cascade", label: "Cascade", ariaLabel: "Cascade", icon: "🗔" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "view.window.freezePanes.freezePanes", label: "Freeze Panes", ariaLabel: "Freeze Panes", icon: "❄️" },
                { id: "view.window.freezePanes.freezeTopRow", label: "Freeze Top Row", ariaLabel: "Freeze Top Row", icon: "⬆" },
                { id: "view.window.freezePanes.freezeFirstColumn", label: "Freeze First Column", ariaLabel: "Freeze First Column", icon: "⬅" },
                { id: "view.window.freezePanes.unfreeze", label: "Unfreeze Panes", ariaLabel: "Unfreeze Panes", icon: "✖" },
              ],
            },
            ...
            { id: "view.window.resetWindowPosition", label: "Reset Window Position", ariaLabel: "Reset Window Position", icon: "↺" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "view.window.switchWindows", label: "Switch Windows…", ariaLabel: "Switch Windows", icon: "🔁" },
                { id: "view.window.switchWindows.window1", label: "Book1.xlsx", ariaLabel: "Switch to Book1", icon: "📄" },
                { id: "view.window.switchWindows.window2", label: "Forecast.xlsx", ariaLabel: "Switch to Forecast", icon: "📄" },
              ],
            },
          ],
        },
          ...
          buttons: [
            {
              ...
              menuItems: [
                { id: "view.macros.viewMacros", label: "View Macros…", ariaLabel: "View Macros", icon: "📜", testId: "ribbon-view-macros-open" },
                { id: "view.macros.viewMacros.run", label: "Run…", ariaLabel: "Run Macro", icon: "▶", testId: "ribbon-view-macros-run" },
                { id: "view.macros.viewMacros.edit", label: "Edit…", ariaLabel: "Edit Macro", icon: "✎", testId: "ribbon-view-macros-edit" },
                { id: "view.macros.viewMacros.delete", label: "Delete…", ariaLabel: "Delete Macro", icon: "🗑", testId: "ribbon-view-macros-delete" },
              ],
            },
            {
              ...
              menuItems: [
                { id: "view.macros.recordMacro", label: "Record Macro…", ariaLabel: "Record Macro", icon: "⏺", testId: "ribbon-view-record-macro-start" },
                { id: "view.macros.recordMacro.stop", label: "Stop Recording", ariaLabel: "Stop Recording", icon: "⏹", testId: "ribbon-view-record-macro-stop" },
              ],
            },
      ...
      groups: [
        {
          ...
          buttons: [
            ...
            },
            {
              ...
              menuItems: [
                { id: "developer.code.macros", label: "Macros…", ariaLabel: "Macros", icon: "📜", testId: "ribbon-developer-macros-open" },
                { id: "developer.code.macros.run", label: "Run…", ariaLabel: "Run Macro", icon: "▶", testId: "ribbon-developer-macros-run" },
                { id: "developer.code.macros.edit", label: "Edit…", ariaLabel: "Edit Macro", icon: "✎", testId: "ribbon-developer-macros-edit" },
              ],
            },
            {
              ...
              menuItems: [
                { id: "developer.code.recordMacro", label: "Record Macro…", ariaLabel: "Record Macro", icon: "⏺", testId: "ribbon-developer-record-macro-start" },
                { id: "developer.code.recordMacro.stop", label: "Stop Recording", ariaLabel: "Stop Recording", icon: "⏹", testId: "ribbon-developer-record-macro-stop" },
              ],
            },
            { id: "developer.code.useRelativeReferences", label: "Use Relative References", ariaLabel: "Use Relative References", icon: "📍", kind: "toggle" },
            {
              ...
              menuItems: [
                { id: "developer.code.macroSecurity", label: "Macro Security…", ariaLabel: "Macro Security", icon: "🔒", testId: "ribbon-developer-macro-security-open" },
                { id: "developer.code.macroSecurity.trustCenter", label: "Trust Center…", ariaLabel: "Trust Center", icon: "🛡", testId: "ribbon-developer-macro-security-trust-center" },
              ],
            },
          ],
        },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "developer.addins.addins.excelAddins", label: "Excel Add-ins…", ariaLabel: "Excel Add-ins", icon: "🧩" },
                { id: "developer.addins.addins.browse", label: "Browse…", ariaLabel: "Browse Add-ins", icon: "📂" },
                { id: "developer.addins.addins.manage", label: "Manage…", ariaLabel: "Manage Add-ins", icon: "⚙️" },
              ],
            },
            {
              ...
              icon: "🔌",
              kind: "dropdown",
              menuItems: [{ id: "developer.addins.comAddins", label: "COM Add-ins…", ariaLabel: "COM Add-ins", icon: "🔌" }],
            },
          ],
        },
        {
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "developer.controls.insert.button", label: "Button", ariaLabel: "Insert Button", icon: "🔘" },
                { id: "developer.controls.insert.checkbox", label: "Check Box", ariaLabel: "Insert Check Box", icon: "☑️" },
                { id: "developer.controls.insert.combobox", label: "Combo Box", ariaLabel: "Insert Combo Box", icon: "▾" },
                { id: "developer.controls.insert.listbox", label: "List Box", ariaLabel: "Insert List Box", icon: "≡" },
                { id: "developer.controls.insert.scrollbar", label: "Scroll Bar", ariaLabel: "Insert Scroll Bar", icon: "↕" },
                { id: "developer.controls.insert.spinButton", label: "Spin Button", ariaLabel: "Insert Spin Button", icon: "⇅" },
              ],
            },
            { id: "developer.controls.designMode", label: "Design Mode", ariaLabel: "Design Mode", icon: "🎛", kind: "toggle" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "developer.controls.properties", label: "Properties…", ariaLabel: "Properties", icon: "⚙️" },
                { id: "developer.controls.properties.viewProperties", label: "View Properties", ariaLabel: "View Properties", icon: "👁" },
              ],
            },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "developer.xml.source", label: "XML Source", ariaLabel: "XML Source", icon: "XML" },
                { id: "developer.xml.source.refresh", label: "Refresh XML Data", ariaLabel: "Refresh XML Data", icon: "⟳" },
              ],
            },
            {
              ...
              icon: "🗺",
              kind: "dropdown",
              menuItems: [{ id: "developer.xml.mapProperties", label: "Map Properties…", ariaLabel: "Map Properties", icon: "🗺" }],
            },
