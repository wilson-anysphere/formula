          ...
          buttons: [
            {
              ...
              size: "small",
              menuItems: [
                { id: "home.number.numberFormat.general", label: "General", ariaLabel: "General", iconId: "numberFormat" },
                { id: "home.number.numberFormat.number", label: "Number", ariaLabel: "Number", iconId: "numberFormat" },
                { id: "home.number.numberFormat.currency", label: "Currency", ariaLabel: "Currency", iconId: "currency" },
                { id: "home.number.numberFormat.accounting", label: "Accounting", ariaLabel: "Accounting", iconId: "currency" },
                ...
                { id: "home.number.numberFormat.percentage", label: "Percentage", ariaLabel: "Percentage", iconId: "percent" },
                { id: "home.number.numberFormat.fraction", label: "Fraction", ariaLabel: "Fraction", iconId: "divide" },
                { id: "home.number.numberFormat.scientific", label: "Scientific", ariaLabel: "Scientific", iconId: "numberFormat" },
                { id: "home.number.numberFormat.text", label: "Text", ariaLabel: "Text", iconId: "fontSize" },
              ],
            },
            {
              id: "format.numberFormat.currency",
              label: "Accounting",
              ...
              size: "icon",
              menuItems: [
                { id: "home.number.accounting.usd", label: "$ (Dollar)", ariaLabel: "Dollar", iconId: "currency" },
                { id: "home.number.accounting.eur", label: "€ (Euro)", ariaLabel: "Euro", iconId: "currency" },
                { id: "home.number.accounting.gbp", label: "£ (Pound)", ariaLabel: "Pound", iconId: "currency" },
                { id: "home.number.accounting.jpy", label: "¥ (Yen)", ariaLabel: "Yen", iconId: "currency" },
              ],
            },
            { id: "format.numberFormat.percent", label: "Percent", ariaLabel: "Percent Style", iconId: "percent", size: "icon" },
            { id: "format.numberFormat.date", label: "Date", ariaLabel: "Date", iconId: "calendar", size: "icon" },
          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "view.zoom.zoom.400", label: "400%", ariaLabel: "Zoom 400%" },
                { id: "view.zoom.zoom.200", label: "200%", ariaLabel: "Zoom 200%" },
                { id: "view.zoom.zoom.150", label: "150%", ariaLabel: "Zoom 150%" },
                { id: "view.zoom.zoom.100", label: "100%", ariaLabel: "Zoom 100%" },
                { id: "view.zoom.zoom.75", label: "75%", ariaLabel: "Zoom 75%" },
                { id: "view.zoom.zoom.50", label: "50%", ariaLabel: "Zoom 50%" },
                { id: "view.zoom.zoom.25", label: "25%", ariaLabel: "Zoom 25%" },
