          ...
          buttons: [
            {
              ...
              size: "large",
              menuItems: [
                { id: "view.macros.viewMacros", label: "View Macros…", ariaLabel: "View Macros", icon: "📜" },
                { id: "view.macros.viewMacros.run", label: "Run…", ariaLabel: "Run Macro", icon: "▶" },
                { id: "view.macros.viewMacros.edit", label: "Edit…", ariaLabel: "Edit Macro", icon: "✎" },
                { id: "view.macros.viewMacros.delete", label: "Delete…", ariaLabel: "Delete Macro", icon: "🗑" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "view.macros.recordMacro", label: "Record Macro…", ariaLabel: "Record Macro", icon: "⏺" },
                { id: "view.macros.recordMacro.stop", label: "Stop Recording", ariaLabel: "Stop Recording", icon: "⏹" },
              ],
            },
      ...
      groups: [
        {
          ...
          buttons: [
            { id: "developer.code.visualBasic", label: "Visual Basic", ariaLabel: "Visual Basic", icon: "VB", size: "large" },
            {
              ...
              size: "large",
              menuItems: [
                { id: "developer.code.macros", label: "Macros…", ariaLabel: "Macros", icon: "📜" },
                { id: "developer.code.macros.run", label: "Run…", ariaLabel: "Run Macro", icon: "▶" },
                { id: "developer.code.macros.edit", label: "Edit…", ariaLabel: "Edit Macro", icon: "✎" },
              ],
            },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "developer.code.recordMacro", label: "Record Macro…", ariaLabel: "Record Macro", icon: "⏺" },
                { id: "developer.code.recordMacro.stop", label: "Stop Recording", ariaLabel: "Stop Recording", icon: "⏹" },
              ],
            },
            { id: "developer.code.useRelativeReferences", label: "Use Relative References", ariaLabel: "Use Relative References", icon: "📍", kind: "toggle" },
            {
              ...
              kind: "dropdown",
              menuItems: [
                { id: "developer.code.macroSecurity", label: "Macro Security…", ariaLabel: "Macro Security", icon: "🔒" },
                { id: "developer.code.macroSecurity.trustCenter", label: "Trust Center…", ariaLabel: "Trust Center", icon: "🛡" },
              ],
            },
          ],
        },
