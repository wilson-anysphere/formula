...
describe("SpreadsheetApp chart formula evaluation", () => {
  beforeEach(() => {
  ...
  it("populates chart data caches using computed values for formula cells", () => {
    ...
    doc.setCellValue(sheetId, { row: 0, col: 0 }, 2);
    doc.setCellValue(sheetId, { row: 1, col: 0 }, 3);
    doc.setCellFormula(sheetId, { row: 0, col: 1 }, "=A1+A2");
