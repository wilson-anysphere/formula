...
describe("SpreadsheetApp clearSelectionContents edit-mode guards", () => {
  beforeEach(() => {
  ...
  it("no-ops clearSelectionContents when the shell reports split-view editing", () => {
    ...
    doc.setCellValue(sheetId, cell, "Hello");
