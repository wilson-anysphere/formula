...
describe("SpreadsheetApp charts large ranges", () => {
  beforeEach(() => {
  ...
  it("renders a placeholder for huge chart ranges without scanning every cell", () => {
    ...
    const getCellSpy = vi.spyOn(doc as any, "getCell");

    const result = app.addChart({
      chart_type: "line",
      data_range: "Sheet1!A1:A200000",
      title: "Huge",
      position: "Sheet1!C1",
    });
