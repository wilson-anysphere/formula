...
describe("SpreadsheetApp clipboard command wrappers sheet switching", () => {
  beforeEach(() => {
  ...
  it("does not steal focus after sheet switch when copyToClipboard finishes", async () => {
    ...
    const copyPromise = app.copyToClipboard();
    await writeCalled;
  ...
  it("does not steal focus after sheet switch when cutToClipboard finishes", async () => {
    const root = createRoot();
    const status = {
      activeCell: document.createElement("div"),
      selectionRange: document.createElement("div"),
    ...
    const cutPromise = app.cutToClipboard();
    await writeCalled;
  ...
  it("does not steal focus after sheet switch when pasteFromClipboard finishes", async () => {
    const root = createRoot();
    const status = {
      activeCell: document.createElement("div"),
      selectionRange: document.createElement("div"),
    ...
    const pastePromise = app.pasteFromClipboard();
    await readCalled;
