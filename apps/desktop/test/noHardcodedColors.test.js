...
test("core UI does not hardcode colors outside tokens.css", () => {
  ...
  const domStyleColor = new RegExp(
    ...
    String.raw`\.\s*style\b\s*\.\s*(?:accentColor|background|backgroundColor|borderColor|borderBottomColor|borderLeftColor|borderRightColor|borderTopColor|caretColor|color|fill|filter|backdropFilter|outlineColor|stroke|textDecoration|textDecorationColor)\s*(?:=|\+=)\s*(["'\`])[^"'\`]*${namedColorToken}[^"'\`]*\1`,
    "gi",
  );
  const domStyleStyleBracketColor = new RegExp(
    ...
    String.raw`\[\s*(?:["'\`])style(?:["'\`])\s*]\s*\.\s*(?<prop>accentColor|background|backgroundColor|borderColor|borderBottomColor|borderLeftColor|borderRightColor|borderTopColor|caretColor|color|fill|filter|backdropFilter|outlineColor|stroke|textDecoration|textDecorationColor)\s*(?:=|\+=)\s*(["'\`])[^"'\`]*${namedColorToken}[^"'\`]*\2`,
    "gi",
  );
  ...
  const domStyleBracketColor = new RegExp(
    ...
    String.raw`\.\s*style\b\s*\[\s*(?:["'\`])(?<prop>accentColor|background|backgroundColor|borderColor|borderBottomColor|borderLeftColor|borderRightColor|borderTopColor|caretColor|color|fill|filter|backdropFilter|outlineColor|stroke|textDecoration|textDecorationColor)(?:["'\`])\s*]\s*(?:=|\+=)\s*(["'\`])[^"'\`]*${namedColorToken}[^"'\`]*\2`,
    "gi",
  );
  ...
  const styleCssTextAssignment = /\.\s*style\b\s*\.\s*cssText\s*(?:=|\+=)\s*(["'\`])\s*(?<value>[^"'`]*?)\1/gi;
  const styleCssTextBracketAssignment =
  ...
  const setAttributeStyleAssignment =
    /\bsetAttribute\s*(?:\(\s*|(?:\?\.|\.)\s*call\s*\(\s*[^,]+,\s*|(?:\?\.|\.)\s*apply\s*\(\s*[^,]+,\s*\[\s*|(?:\?\.|\.)\s*bind\s*\(\s*[^)]*\)\s*\(\s*)(["'])style\1\s*,\s*(["'\`])\s*(?<value>[^"'`]*?)\2/gi;
  const setAttributeStyleBracketAssignment =
    /\[\s*(?:["'\`])setAttribute(?:["'\`])\s*]\s*(?:\(\s*|(?:\?\.|\.)\s*call\s*\(\s*[^,]+,\s*|(?:\?\.|\.)\s*apply\s*\(\s*[^,]+,\s*\[\s*|(?:\?\.|\.)\s*bind\s*\(\s*[^)]*\)\s*\(\s*)(["'])style\1\s*,\s*(["'\`])\s*(?<value>[^"'`]*?)\2/gi;
  const setPropertyStyleColor = new RegExp(
    ...
    String.raw`\.\s*style\b\s*(?:\?\.|\.)\s*setProperty\s*(?:\(\s*|(?:\?\.|\.)\s*call\s*\(\s*[^,]+,\s*|(?:\?\.|\.)\s*apply\s*\(\s*[^,]+,\s*\[\s*|(?:\?\.|\.)\s*bind\s*\(\s*[^)]*\)\s*\(\s*)(["'\`])(?<prop>[-\w]+)\1\s*,\s*(["'\`])[^"'\`]*${namedColorToken}[^"'\`]*\3`,
    "gi",
  );
  const setPropertyStyleStyleBracketColor = new RegExp(
    ...
    String.raw`\[\s*(?:["'\`])style(?:["'\`])\s*]\s*(?:\?\.|\.)\s*setProperty\s*(?:\(\s*|(?:\?\.|\.)\s*call\s*\(\s*[^,]+,\s*|(?:\?\.|\.)\s*apply\s*\(\s*[^,]+,\s*\[\s*|(?:\?\.|\.)\s*bind\s*\(\s*[^)]*\)\s*\(\s*)(["'\`])(?<prop>[-\w]+)\1\s*,\s*(["'\`])[^"'\`]*${namedColorToken}[^"'\`]*\3`,
    "gi",
  );
  const setPropertyStyleBracketColor = new RegExp(
    ...
    String.raw`\.\s*style\b\s*(?:\?\.)?\s*\[\s*(?:["'\`])setProperty(?:["'\`])\s*]\s*(?:\(\s*|(?:\?\.|\.)\s*call\s*\(\s*[^,]+,\s*|(?:\?\.|\.)\s*apply\s*\(\s*[^,]+,\s*\[\s*|(?:\?\.|\.)\s*bind\s*\(\s*[^)]*\)\s*\(\s*)(["'\`])(?<prop>[-\w]+)\1\s*,\s*(["'\`])[^"'\`]*${namedColorToken}[^"'\`]*\3`,
    "gi",
  );
  const setPropertyStyleStyleBracketBracketColor = new RegExp(
    ...
    String.raw`\[\s*(?:["'\`])style(?:["'\`])\s*]\s*(?:\?\.)?\s*\[\s*(?:["'\`])setProperty(?:["'\`])\s*]\s*(?:\(\s*|(?:\?\.|\.)\s*call\s*\(\s*[^,]+,\s*|(?:\?\.|\.)\s*apply\s*\(\s*[^,]+,\s*\[\s*|(?:\?\.|\.)\s*bind\s*\(\s*[^)]*\)\s*\(\s*)(["'\`])(?<prop>[-\w]+)\1\s*,\s*(["'\`])[^"'\`]*${namedColorToken}[^"'\`]*\3`,
    "gi",
  );
  const setAttributeColor = new RegExp(
    // SVG/DOM attribute assignments (e.g. `el.setAttribute("fill", "red")`)
    String.raw`\bsetAttribute\s*(?:\(\s*|(?:\?\.|\.)\s*call\s*\(\s*[^,]+,\s*|(?:\?\.|\.)\s*apply\s*\(\s*[^,]+,\s*\[\s*|(?:\?\.|\.)\s*bind\s*\(\s*[^)]*\)\s*\(\s*)(["'])(?:fill|stroke|color|stop-color|flood-color|lighting-color)\1\s*,\s*(["'\`])[^"'\`]*${namedColorToken}[^"'\`]*\2`,
    "gi",
  );
  const setAttributeBracketColor = new RegExp(
    // SVG/DOM attribute assignments via bracket notation (e.g. `el["setAttribute"]("fill", "red")`)
    String.raw`\[\s*(?:["'\`])setAttribute(?:["'\`])\s*]\s*(?:\(\s*|(?:\?\.|\.)\s*call\s*\(\s*[^,]+,\s*|(?:\?\.|\.)\s*apply\s*\(\s*[^,]+,\s*\[\s*|(?:\?\.|\.)\s*bind\s*\(\s*[^)]*\)\s*\(\s*)(["'])(?:fill|stroke|color|stop-color|flood-color|lighting-color)\1\s*,\s*(["'\`])[^"'\`]*${namedColorToken}[^"'\`]*\2`,
    "gi",
  );
