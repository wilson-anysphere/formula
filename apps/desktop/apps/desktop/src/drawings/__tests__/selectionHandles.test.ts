...
//
// `pnpm -C apps/desktop exec vitest …` executes from the `apps/desktop/` directory, so paths
// prefixed with `apps/desktop/` are interpreted relative to that root. This file bridges that
